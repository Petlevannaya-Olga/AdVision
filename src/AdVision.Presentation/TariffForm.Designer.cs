namespace AdVision.Presentation
{
	partial class TariffForm
	{
		...
		private void InitializeComponent()
		{
			...
			panel5.Location = new Point(403, 236);
			panel5.Name = "panel5";
			...
			txtDescription.Size = new Size(355, 270);
			...
			panel4.Location = new Point(403, 124);
			panel4.Name = "panel4";
			...
			txtHeight.Size = new Size(170, 27);
			...
			panel3.Location = new Point(403, 11);
			panel3.Name = "panel3";
			...
			txtLatitude.Size = new Size(170, 27);
			...
			txtLongitude.Size = new Size(170, 27);
			...
			panel2.Location = new Point(8, 237);
			panel2.Name = "panel2";
			...
			txtDistrict.Size = new Size(354, 27);
			...
			txtStreet.Size = new Size(355, 27);
			...
			txtHouseNumber.Size = new Size(355, 27);
			...
			txtRating.Location = new Point(17, 168);
			txtRating.Name = "txtRating";
			txtRating.ReadOnly = true;
			txtRating.Size = new Size(354, 27);
			txtRating.TabIndex = 1;
			// 
			// txtType
			// 
			txtType.BorderStyle = BorderStyle.FixedSingle;
			txtType.Location = new Point(17, 115);
			txtType.Name = "txtType";
			txtType.ReadOnly = true;
			txtType.Size = new Size(354, 27);
			txtType.TabIndex = 1;
			// 
			// txtName
			// 
			...
			dgvTariffs.Location = new Point(403, 571);
			dgvTariffs.Name = "dgvTariffs";
			dgvTariffs.RowHeadersWidth = 51;
			dgvTariffs.Size = new Size(389, 168);
			dgvTariffs.TabIndex = 19;
			// 
			// btnClose
			// 
			btnClose.FlatStyle = FlatStyle.Popup;
			btnClose.Location = new Point(606, 745);
			btnClose.Name = "btnClose";
			btnClose.Size = new Size(187, 29);
			...
			btnCreate.Location = new Point(403, 745);
			...
			label21.Location = new Point(191, 87);
			label21.Name = "label21";
			label21.Size = new Size(26, 20);
			label21.TabIndex = 11;
			label21.Text = "до";
			// 
			// label22
			...
			label22.Location = new Point(9, 89);
			...
			label20.Location = new Point(191, 49);
			...
			label19.Location = new Point(16, 49);
			...
			Text = "Тарифы площадки";
			FormClosed += TariffForm_FormClosed;
