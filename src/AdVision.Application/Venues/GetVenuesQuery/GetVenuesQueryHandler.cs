...
{
    public async Task<Result<IReadOnlyList<VenueDto>, Errors>> Handle(GetVenuesQuery query,
        CancellationToken cancellationToken = default)
    {
        var result = await repository.GetAsync(query.Page, query.Size, cancellationToken);
